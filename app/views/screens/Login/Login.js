...
import {View, Text, TouchableWithoutFeedback, Image, TouchableOpacity, Dimensions, ScrollView} from 'react-native'
    ...
    <View style = {{ flex: 1, backgroundColor: 'white' }}>
      <ScrollView>
        ...
        <View style={{height: 150, marginVertical: '10%'}}>
          <Image resizeMode='contain' source={parentlineLogo} style={{width: '100%', height: 150}} />
        </View>
        ...
        {showLogin? 
          <View>
            ...
            <View style={{height: 70, marginVertical: '10%',}}>
              <Text style={{marginLeft: width*.3, color: '#BCBCBC', fontSize: 15}}>Powered by,</Text>
              <Image resizeMode='contain' source={headstartLogo} style={{width: '100%', height: 70}} />
            </View>
          </View>
        :
          <View style={{marginBottom: 35}}>
